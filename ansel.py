...
class Codec(codecs.Codec):
    ...
    def decode(self,input,errors='strict'):
        return AnselReader.ansel_to_unicode(input), len(input)
...
codecs.register(regentry)

if __name__ == '__main__':
    from StringIO import StringIO
    fd = StringIO('test')
    f = codecs.getreader('ansel')(fd, 'replace')
    assert f.read() == 'test'
